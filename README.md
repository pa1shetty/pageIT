# pageIT App
App allows to login via facebook see all his pages and see page feeds.
and upload page details to backend and show notifcation regarding this.
...
- [Facebook SDK for Android](https://developers.facebook.com/docs/android) - For user Login and other datas
